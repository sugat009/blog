...
urlpatterns = [
    ...
    url(r'^posts/detail/(?P<pk>\d+)/(?P<user_id>\d+)/$', PostUpdateRetriveDestroyView.as_view(), name="posts_detail"),

    # for user post list
    url(r'posts/user/list/(?P<pk>\d+)/$', UserPostListAPIView.as_view(), name="user_posts_list"),
