...
class PostListViewApi(ListCreateAPIView):
	queryset = Posts.objects.filter(deleted_at__isnull=True).order_by('-created_at')
...
class PostUpdateRetriveDestroyView(RetrieveUpdateDestroyAPIView):
	...
	def dispatch(self, request, *args, **kwargs):
		self.posts = Posts.objects.filter(deleted_at__isnull = True, author_id = kwargs.get("user_id"))
